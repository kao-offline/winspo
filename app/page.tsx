    ...
    <div className="flex flex-1 flex-col">
      <header className="border-b border-border-soft">
        <div className="mx-auto flex max-w-6xl items-center gap-2.5 px-4 py-4">
          ...
          <span className="text-lg font-bold tracking-tight">WInspo</span>
          <span className="ml-auto hidden text-sm text-text/50 sm:block">
            No login · no accounts · just a code
          </span>
        </div>
      </header>
